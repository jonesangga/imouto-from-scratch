...
describe("lexer", function()
    ...
    it("brackets", function()
        ...
        expect( lexer("[") ).to.equal( {t(TT.LSQUARE, nil, 1)} )
        expect( lexer("]") ).to.equal( {t(TT.RSQUARE, nil, 1)} )
    ...
    it("others", function()
        ...
        expect( lexer("#") ).to.equal( {t(TT.HASH, nil, 1)} )
        expect( lexer("%") ).to.equal( {t(TT.PERCENT, nil, 1)} )
